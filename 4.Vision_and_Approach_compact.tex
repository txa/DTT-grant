...
With univalence, identity types carry higher structure: equalities form paths, paths between paths, etc., so types behave like $\infty$-groupoids.

Many constructions require coherence or naturality, often consequences of parametricity. In DTT, coherence becomes intrinsic, linking univalence and parametricity.
