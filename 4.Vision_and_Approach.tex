...
\usepackage[backend=biber,style=alphabetic,sorting=nyt,natbib=true,maxcitenames=2,maxbibnames=99]{biblatex}
...
\newcommand{\hybridOne}{\teamm{HM1}{WPcolour}}
\newcommand{\hybridTwo}{\teamm{HM2}{WPcolour}}
...
% ==== FINAL SQUEEZE tweaks (no geometry) ====
\usepackage{microtype}

\usepackage{enumitem}
\setlist[itemize]{leftmargin=1em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt}
\setlist[enumerate]{leftmargin=1em,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt}

\usepackage[compact]{titlesec}
\titlespacing*{\section}{0pt}{*1.25}{*0.65}
\titlespacing*{\subsection}{0pt}{*0.75}{*0.45}
\titlespacing*{\subsubsection}{0pt}{*0.55}{*0.35}
\titlespacing*{\paragraph}{0pt}{*0.45}{*0.3}
...
\@ifundefined{bibsep}{}{\setlength{\bibsep}{0pt plus 0.2ex}}
\makeatother
...
With univalence, identity types carry higher structure: equalities
form paths, paths between paths, etc., so types behave like
$\infty$-groupoids.  Many constructions require coherence or
naturality, often consequences of parametricity. In DTT, coherence
becomes intrinsic, linking univalence and parametricity.
...
\item \textbf{Directed second-order structure:} To reduce the
  ...
  and scalable syntax~for~\mbox{1-DTT}. 
...
and address the resulting coherence issues, reformulating \cite{kraus2021internal} in a directed setting, where it becomes significantly simpler and more usable.
...
significant progress and strongly validate the relevance of DTT to
real-world mathematical and physical reasoning.\\
\textbf{Collaborators:} Schreiber, Schenkel (UoN Mathematics)
...
%		\ganttbar[inline, bar/.append style={draw=none}]{\deliv}{9}{8}
		\\
		\ganttbar[bar/.append style={draw=none}]{Hybrid Meetings}{0}{-1}
...
%		\ganttbar[inline, bar/.append style={draw=none}]{\tmN}{4}{3}
		\ganttbar[inline, bar/.append style={draw=none,left=2mm}]{\hybridOne}{2}{1}
		\ganttbar[inline, bar/.append style={draw=none,left=5mm}]{\hybridTwo}{6}{5}
		\\
		\ganttbar[bar/.append style={draw=none}]{Workshops}{0}{-1}
		%		\ganttbar[inline, bar/.append style={draw=none}]{\tmN}{2}{1}
		%		\ganttbar[inline, bar/.append style={draw=none}]{\tmS}{3}{2}
		%		\ganttbar[inline, bar/.append style={draw=none}]{\tmN}{4}{3}
		\ganttbar[inline, bar/.append style={draw=none,right=1mm}]{\wsOne}{9}{7}
...
We will organise two hybrid meetings (in-person with the possibility to attend online).
The purpose of these meetings will be to discuss our plans with several collaborators at the same time, and solicit valuable feedback.
The first meeting will take place early during the project, and we will invite the project partners for WPs 1--5.
At this point, we will present a preliminary version of 1-DTT and plan the next steps.
At the time of the second meeting, we will have a version of $\infty$-DTT to present and will focus on the applications of this theory. We will invite our project partners for WPs 6 and 7, but the workshop will also be open to interested members of the community.

Towards the end of the project, we will organise a dissemination workshop, open to everyone who is interested, to present and discuss our results.
