...
%		\ganttbar[inline, bar/.append style={draw=none}]{\tmN}{4}{3}
		\ganttbar[inline, bar/.append style={draw=none,left=8mm}]{\wsOne}{2}{1}
		\ganttbar[inline, bar/.append style={draw=none,left=1mm}]{\wsTwo}{6}{5}
...
Most meetings with our external project partners and collaborators will take place online and scheduled based on requirements.


\todo[inline]{2 workshops: 1 in the beginning, one in the middle; invite relevant collaborators. Regular team meetings, remote meetings with relevant collaborators; local team meetings, PDRA supervision.}
